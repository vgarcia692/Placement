                       ...
                       <?php $i = $page + 1; ?>
                        <?php foreach ($exams as $exam) { ?>
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary" onclick="score('<?php echo $exam['id']; ?>','<?php echo $page; ?>')">Score Final Placement</button>
                                </td>
                            </tr>
                        <?php } ?>
...
<div class="visible-print-block">
    ...
    <div class="col-md-10 col-md-offset-1">
        <table class="table table-striped table-hover">
            ...
            <tbody>
               <?php $i = 1; ?>
                <?php foreach ($allExamsForPrint as $exam) { ?>
                    <tr>
                        <td><?php echo $i++; ?></td>
                        <td><?php echo $exam['id']; ?></td>
                        <td><?php echo $exam['lu_score']; ?></td>
